...
Выполнил: Маркин Андрей 
Логин GitHub: amarkin663  
 
 
## 1. Создан аккаунт на GitHub
- Логин: **amarkin663** (первая буква имени + фамилия)
...
```bash
$ git config user.name "amarkin663"
$ git config user.email "rnbrt122@gmail.com"
